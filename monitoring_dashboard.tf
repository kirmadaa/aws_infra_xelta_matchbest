  ...
  "widgets": [
    {
      ...
      "properties": {
        "metrics": [
          ...
          [ "...", "ClusterName", "${module.ecs_service_eu_central_1.cluster_name}", "ServiceName", "${module.ecs_service_eu_central_1.backend_service_name}" ],
          [ "...", "ClusterName", "${module.ecs_service_ap_south_1.cluster_name}", "ServiceName", "${module.ecs_service_ap_south_1.backend_service_name}" ]
        ],
        "period": 300,
        "stat": "Average",
        "region": "us-east-1",
